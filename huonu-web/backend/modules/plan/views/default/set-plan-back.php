    ...
    <div class="control-group pd15">
        ...
        <div class="form-inline pd10">
            ...
            <input style="width: 300px" type="text" class="form-control campaign-name" placeholder="请输入计划名称"
                   name="name" value="<?= $setPlan['campaign_name']; ?>">
        </div>

        <div class="form-inline pd10">
            <label for="name">付费方式</label>
            <label class="radio-inline">
                <input type="radio" name="payment_type" class="payment-type" value="2" checked> 按展现付费（CPM）
            </label>
            <label class="radio-inline">
                <input type="radio" name="payment_type" class="payment-type" value="8"> 按点击付费（CPC）
            </label>
        </div>
...
<!--                </div>-->
                            ...
                            <div class="pr pdl25 dpIb w100">
                                ...
                                <div class="regionProvince">
                                    <div class="provinceItem">
                                        <input type="checkbox" name="area-id-list[]" class="common-area" checked
                                               value="1"> 安徽
                                    </div>
                                </div>
                            </div>
        ...
        <div class="form-inline pd10">
                    ...
                    <div class="period">
                        <ul class="hours mt40">
                            ...
                            <li class="all allselected" style="width: 70%">
                                <select id="work-days" name="workdays" class="selectpicker form-control"
                                    ...
                                    <option value="true">6</option>
                                    <option value="true">7</option>
                                    <option value="true">8</option>
                                    <option value="true">9</option>
                                    <option value="true">10</option>
                                    <option value="true">11</option>
                                    <option value="true">12</option>
                                    <option value="true">13</option>
                                    <option value="true">14</option>
                                    <option value="true">15</option>
                                    <option value="true">16</option>
                                    <option value="true">17</option>
                                    <option value="true">18</option>
                                    <option value="true">19</option>
                                    <option value="true">20</option>
                                    <option value="true">21</option>
                                    <option value="true">22</option>
                                    <option value="true">23</option>
                        ...
                        <ul class="hours mt40">
                            ...
                            <li class="all allselected" style="width: 70%">
                                <select id="week-ends" name="week_ends" class="selectpicker show-tick form-control"
                                        data-live-search="true" data-actions-box="true" multiple>
                                    <option value="true">1</option>
                                    <option value="true">2</option>
                                    <option value="true">3</option>
            ...
            <!--                                    <span class="hourInnerTop"></span>-->
            <!--                                </div>-->
            <!--                                <div class="curLineStart" style="z-index: 33; display: none;">-->
            <!--                                    <span class="lineArrow"></span>-->
            <!--                                    <span class="lineInfo">23</span>-->
            <!--                                </div>-->
            <!--                                <div class="curLineEnd" style="z-index: 33; display: block;">-->
            <!--                                    <span class="lineArrow"></span>-->
            <!--                                    <span class="lineInfo">24</span>-->
            <!--                                </div>-->
            <!--                                <div class="hourLine">-->
        ...
        <div class="form-inline pd10">
            ...
            <input type="hidden" class="campaign-start-time" name="start_time">
            <input type="hidden" class="campaign-end-time" name="end_time">
        </div>

        <div class="form-inline pd10">
            <label for="name">投放方式</label>
            <label class="radio-inline">
                <input type="radio" name="speed_type" class="campaign-speed-type" value="1" checked>
                尽快投放
            </label>
            <label class="radio-inline">
                <input type="radio" name="speed_type" class="campaign-speed-type" value="2"> 均匀投放
            </label>
        </div>
