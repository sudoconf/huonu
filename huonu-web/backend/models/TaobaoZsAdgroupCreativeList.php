...
/**
 * This is the model class for table "taobao_zs_adgroup_creative_list".
 *
 ...
 */
class TaobaoZsAdgroupCreativeList extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'taobao_zs_adgroup_creative_list';
    }
    ...
    {
        return [
            [['taobao_user_id', 'campaign_id', 'adgroup_id', 'creative_id'], 'required'],
            [['audit_status', 'cat_id', 'creative_level', 'format', 'package_type', 'multi_materials'], 'integer'],
            [['last_update_time'], 'safe'],
            [['taobao_user_id', 'audit_time', 'create_time', 'modified_time', 'exprie_time'], 'string', 'max' => 100],
            [['campaign_id', 'adgroup_id', 'creative_id', 'cat_name', 'creative_size'], 'string', 'max' => 45],
            [['creative_name', 'click_url', 'image_path'], 'string', 'max' => 255],
            [['taobao_user_id', 'campaign_id', 'adgroup_id', 'creative_id'], 'unique', 'targetAttribute' => ['taobao_user_id', 'campaign_id', 'adgroup_id', 'creative_id']],
        ];
    }
